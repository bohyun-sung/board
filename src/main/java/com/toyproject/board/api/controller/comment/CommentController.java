...
import com.toyproject.board.api.dto.comment.response.CommentListRes;
...
public class CommentController {
    ...
    public Response<Page<CommentListRes>> getComments(
            @PathVariable Long postIdx,
            @ParameterObject @PageableDefault (size = 10) Pageable pageable) {
        return Response.success(commentService.getComments(postIdx, pageable).map(CommentListRes::from));
    }
