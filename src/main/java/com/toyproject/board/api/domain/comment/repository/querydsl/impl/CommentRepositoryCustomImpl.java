...
import com.toyproject.board.api.domain.comment.entity.QComment;
...
public class CommentRepositoryCustomImpl implements CommentRepositoryCustom {
    ...
    public Page<CommentDto> findByCondition(Long postIdx, Pageable pageable) {
        ...
        List<CommentDto> treeResult = convertToTree(allComments);
    ...
    private List<CommentDto> convertToTree(List<Comment> allComments) {
